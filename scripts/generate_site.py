...
CLIENT = f'''
<section class="page-hero client-hero"><div class="shell narrow" data-reveal><p class="eyebrow">Client access</p><h1>Your secure onboarding checklist is live.</h1><p class="lede">The private portal uses single-use invitations, server-derived household access, expiring sessions, and quarantined document uploads. No client records are stored in this public website.</p><div class="status-pill" role="status"><span aria-hidden="true"></span> Secure portal: live</div></div></section>
<section class="section shell"><div class="client-route" data-reveal><div><p class="eyebrow">For invited clients</p><h2>Open the private link Markos sent you.</h2><p>Your invitation identifies your household and exact document checklist. A generic portal visit cannot expose or create a client session.</p><a class="button" href="https://gordon-greco-client-portal.markterzidis.workers.dev/portal/" rel="noopener noreferrer">Open secure portal</a></div><ol><li><span>1</span><div><h3>Use your single-use invitation</h3><p>Open the complete private link delivered through the confirmed Gordon Greco communication channel.</p></div></li><li><span>2</span><div><h3>Upload only requested items</h3><p>Accepted files remain quarantined until Markos reviews them. The portal never previews untrusted uploads.</p></div></li><li><span>3</span><div><h3>Ask when anything looks wrong</h3><p>Missing, expired, or unexpected link? Contact Markos instead of trying alternate sign-in pages.</p></div></li></ol><a class="button button-light" href="mailto:{EMAIL}?subject=Client%20access%20help">Contact Markos about access</a></div></section>
...
PAGES = {
    ...
    "client.html": dict(title="Client Access | Gordon Greco", description="Secure invitation-only onboarding and document portal for Gordon Greco clients.", path="client.html", page="client", body=CLIENT, noindex=True, body_attrs='data-portal-state="live"'),
